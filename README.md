...
**Core Expertise:**  
📱 Mobile Apps | 🌐 Web Platforms | 🗄️ DBMS | ⚡ MERN Stack | 🤖 AI (YOLO) | 📊 Analytics
...
- Built with **Next.js 15, React 19, TypeScript, Node.js, MongoDB**
- **RBAC (Super Admin / Admin / Employee)** with separate portals
- Attendance with **IP-based geofencing**, leave & task management
- **Real-time updates (Socket.io)** + PDF/Excel reporting

### 🚦 RastaNigheban.ai
**AI-Based Road Safety System**
- React Native app with **YOLOv8 pothole detection**
- Live alerts + navigation
- **Django backend** for geospatial processing

### 👨‍💼 HR Management System
- Candidate management, interview scheduling & coding assessments
- Secure auth, RBAC & analytics
...
- React, Node.js, MongoDB, Docker, Nginx, Cloudinary
...
✨ *Always open to collaborating on impactful AI, Web & Mobile projects!* ✨
